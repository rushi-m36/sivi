          ...
          <div className="relative w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 shadow-xl dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <div className="pr-6">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
                SIVI is currently deployed on a free-tier server that may
                temporarily stop when there is no activity. Because of this, the
                first load may take a few seconds while the server starts again.
                After that, SIVI should load normally and quickly.
              </p>

              <p className="mt-3 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
                We plan to move to a paid server soon for a faster and more
                consistent experience. Until then, please be patient with the
                initial load.
              </p>
            </div>
